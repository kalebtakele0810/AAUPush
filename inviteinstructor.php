...
<body>
	<div class="container-fluid">
		...
		<?php
            ...
            $url='http://localhost:8080/server/InviteServlet';
		...
		<div class="row">
			<div class="col-md-6" style = "margin-top:0px;">
				<div class="panel panel-default">
					  <h2 style = "margin-left:20px;">Invite Instructor Page</h2>
					<div class="panel-body">
						<form method="post" action="index.php" class="form-horizontal" role="form">
								<input class="form-control" name="email" type="email" placeholder="Email of the teacher" required>
