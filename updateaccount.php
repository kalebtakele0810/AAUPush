...
<body>
	<div class="container-fluid">
		...
		<?php
			...
			$url='http://localhost:8080/server/AccountServlet';
		...
		<div class="row">
			<div class="col-md-6" style = "margin-top:0px;">
				<div class="panel panel-default">
					  <h2 style = "margin-left:20px;">Update Account Page</h2>
					<div class="panel-body">
						<form method="post" action="index.php" class="form-horizontal" role="form">
								<input class="form-control" name="id" type="number" placeholder="Id of the user" required>
