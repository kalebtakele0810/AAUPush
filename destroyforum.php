...
<body>
	<div class="container-fluid">
		...
		<?php
			...
			$url='http://localhost:8080/server/ForumServlet';
		...
		<div class="row">
			<div class="col-md-6" style = "margin-top:0px;">
				<div class="panel panel-default">
					  <h2 style = "margin-left:20px;">Destroy Forum Page</h2>
					<div class="panel-body">
						<form method="post" action="index.php" class="form-horizontal" role="form">
								<input class="form-control" name="id" type="number" placeholder="Id of the forum to delete" required>
                                <button class="btn" type="submit">Destroy</button>
						</form>
					</div>
				</div>
			</div>
