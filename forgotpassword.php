...
<body>
	<div class="container-fluid">
		...
		<?php
            ...
            $url='http://localhost:8080/server/RecoveryServlet';
		...
		<div class="row">
			<div class="col-md-6" style = "margin-top:0px;">
				<div class="panel panel-default">
					  <h2 style = "margin-left:20px;">Forgot Password Page</h2>
					<div class="panel-body">
						<form method="post" action="index.php" class="form-horizontal" role="form">
								<input class="form-control" name="email" type="email" placeholder="What is your email?" required>
                                <button class="btn" type="submit">Send Recovery</button>
						</form>
					</div>
				</div>
			</div>
